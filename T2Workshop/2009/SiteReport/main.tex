...
\subsection{Current status: Storage}
\begin{frame}
\begin{table}
\begin{tabular}{lr}
    \toprule
    Dedicated storage   &   NNN TB \\
    Dual-purpose        &   NNN TB \\
    \midrule
    Raw                 &   NNN TB \\
    Replicated          &   NNN TB \\
...
\subsection{Current Status: Batch}
\begin{frame}
\begin{figure}
    % http://noc.hep.wisc.edu/nrg/condor/pools/GLOW-condor-claimed.1yr.gif
    \includegraphics[height=3.0cm]{Graphics/GLOW-condor-claimed-1yr.png}
